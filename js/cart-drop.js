...
class CartDrop {
    ...
    _renderItem(product) {
        let $productContainer = $('<div/>', {
            ...
            $rmvBtn = $(`<i class="fas fa-times-circle shut" data-id="${product.id}"></i>`);
    ...
    _renderButtons() {
        let $checkoutButton = $(`<a href="checkout.html" class="cart-product__checkout">Checkout</a>`),
            $cartButton = $(`<a href="shopping-cart.html" class="cart-product__go-to-cart">Go&nbsp;to&nbsp;cart</a>`);
    ...
    _removeButtons() {
        $('.cart-product__checkout').remove();
        $('.cart-product__go-to-cart').remove();
    }
